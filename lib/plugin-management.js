...
/**
 * Provides methods to manage minimap plugins. Minimap plugins are Lumine packages that will augment the minimap. They
 ...
 *
 * 1. The plugin module is activated by Lumine through the `activate` method
