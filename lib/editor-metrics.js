/**
 * The editor scroll metrics the minimap renders against, with an opt-in cache so a single
 * update reads each of them at most once.
 *
 * @access private
 */
class EditorMetrics {
  constructor(textEditor) {
    ...
    this.textEditorElement = lumine.views.getView(this.textEditor);
  }
