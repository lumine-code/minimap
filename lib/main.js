...
export function toggle() {
  ...
  // Notify scroll-keeper to preserve scroll position during layout change
  atom.workspace.getTextEditors().forEach((editor) => {
    editor.emitter.emit("scroll-keeper-requested");
  });
  ...
  // Force editor components to re-measure after minimap elements are added/removed
